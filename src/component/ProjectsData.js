...
"succes": "true",
   "data": {
    ...
    "title": "Trivia-Quiz",
    "button": "",
    "image": `${process.env.PUBLIC_URL + '/images/quizapp.png'}`,
...
{
    "title": "Tenzies-Game",
    "image":`${process.env.PUBLIC_URL + '/images/tenzies_game.png'}`,
...
{
    "title": "Gif-You",
    "image":`${process.env.PUBLIC_URL + '/images/gifyou.png'}`,
...
{
    "title": "Opine-Notes",
    "image": `${process.env.PUBLIC_URL + '/images/notes.png'}`,
...
{
    "title": "CardShoper",
    "image": `${process.env.PUBLIC_URL + '/images/cardshoper.png'}`,
